...
wayland.windowManager.sway = {
    enable = true;
    checkConfig = false; # Hata riskini sıfırlar
    ...
    config = {
      ...
      # Bar Ayarı: Burada Nix'in gücünü kullanıyoruz.
      # pkgs.i3status-rust otomatik indirilir, config dosyası ise aşağıda oluşturulur.
      bars = [
        {
          command = "swaybar";
          position = "top";
          # Bu komut çalıştığında hem program hem config dosyası yerinde olacak
          ...
          colors = {
            ...
            statusline = "#cdd6f4";
            separator  = "#6c7086";
            focusedWorkspace = { border = "#cba6f7"; background = "#cba6f7"; text = "#1e1e2e"; };
            inactiveWorkspace = { border = "#181825"; background = "#181825"; text = "#cdd6f4"; };
          };
        }
      ];

      input = {
        "type:keyboard" = { xkb_layout = "tr"; };
        "type:touchpad" = { dwt = "enabled"; tap = "enabled"; natural_scroll = "enabled"; };
      };

      gaps = { inner = 5; outer = 5; };
